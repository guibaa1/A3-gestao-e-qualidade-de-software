...
public class RepositorioFuncionario {
   static Scanner scanner = new Scanner(System.in);
    public static void SalvarFuncionario(String nome, String cpf){
    ...
    public static void AtualizarFuncionarioPorId(int id){
        try (Connection conexao = DriverManager.getConnection(URL, USUARIO, SENHA)) {
    ...
    public static void DeletarFuncionarPorId(int id){
        try (Connection conexao = DriverManager.getConnection(URL, USUARIO, SENHA)) {
